...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	DefaultSSDesc.AddressU = D3D11_TEXTURE_ADDRESS_CLAMP;
	DefaultSSDesc.AddressV = D3D11_TEXTURE_ADDRESS_CLAMP;
	DefaultSSDesc.AddressW = D3D11_TEXTURE_ADDRESS_CLAMP;
